...
Check out Ms. Claudia (a fully procedurally generated Ms. Pac-Man clone) code [here](Games/MsClaudia/README.md) or play the game [v1.2 release](https://github.com/itzjac/aidriven/releases/tag/v1.2).
