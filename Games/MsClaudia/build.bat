...
rc /fo "intermediate\\resource.res" resource.rc 
...
cl %CommonCompilerFlags% %EXTRA_DEFS% /Fointermediate\ game.cpp loader.cpp intermediate\\resource.res /link /SUBSYSTEM:WINDOWS /LIBPATH:..\\lib %CommonLinkerFlags% /OUT:build\%OUT_NAME%
